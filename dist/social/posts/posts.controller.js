...
const create_posts_1 = require("./dtos/create-posts");
...
let PostsController = class PostsController {
    ...
    async createPost(createPostDto, user, id) {
        const post = await this.postService.createRecord(Object.assign(Object.assign({}, createPostDto), { creator: user._id, group: id }));
        await this.groupService.findOneRecordAndUpdate({ _id: id }, { $push: { posts: post._id } });
        return post;
    }
    async create(createPostsDto, user) {
...
__decorate([
    (0, common_1.Post)('create-post/:id'),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, user_decorator_1.GetUser)()),
    __param(2, (0, common_1.Param)('id', ParseObjectId)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_posts_1.CreatePostsDto, Object, String]),
