...
AddressModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: address_schema_1.Address.name, schema: address_schema_1.AddressSchema }]), (0, common_1.forwardRef)(() => users_module_1.UsersModule)],
