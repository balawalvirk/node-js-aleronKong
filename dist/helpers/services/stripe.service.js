...
let StripeService = class StripeService {
    constructor(configService) {
        ...
        this.findAllTransfers = (params, options) => this.stripe.transfers.list(params, options);
    }
    ...
    async updatePaymentIntent(id, params, options) {
    ...
    async findOneAccount(id, params, options) {
    ...
    async findAllAccounts(params, options) {
    ...
    async createConnectedAccountPayout(params, options) {
        return await this.stripe.payouts.create(params, options);
    }
    async findConnectedAccountBalance(account) {
